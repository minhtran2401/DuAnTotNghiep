...
@section('pagetitle', "THÊM NHÓM SẢN PHẨM")
@section('main')
...
<div class="main-content" style="min-height: 659px;">
    <section class="section">
      <div class="section-body">
              ...
              <div class="col-lg-7 col-md-6 col-sm-12">
                  ...
                  <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('nhom-san-pham.index')}}"><i class="far fa-file"></i> NHÓM SẢN PHẨM</a></li>
                      <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i> THÊM NHÓM SẢN PHẨM</li>
                    </ol>
                  </nav>
                  {{-- <h2>NHÓM SẢN PHẨM</h2> --}}
              </div>
        ...
        <div class="container">
        <div class="cart">
              <form id="form_validation" method="POST" action="{{route('nhom-san-pham.store')}}" enctype="multipart/form-data" >
                {{csrf_field()}}
                    <div class="form-group row" >
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" placeholder="Tên Nhóm Sản Phẩm" name="name_nhomsp" >
                        @foreach($errors->get('name_nhomsp') as $error)
                          <span class="badge badge-danger">{{ $error }}</span>
                        @endforeach
                    </div>
                    <div class="form-group col-md-12">
                      <label for="icon_nhomsp">Hình Nhóm Sản Phẩm</label>
                  ...
                  <div class="form-group col-md-12" >
                    ...
                    <input type="text" class="form-control" placeholder="Bỏ code bên phải vào đây !!" name="hinh_nhomsp" >
                    @foreach($errors->get('hinh_nhomsp') as $error)
                          <span class="badge badge-danger">{{ $error }}</span>
                        @endforeach
                  </div>
                    <div class="form-group col-md-12"> 
